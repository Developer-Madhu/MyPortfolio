  ...
  return (
    ...
    >
      ...
      <motion.h1
        ...
        className="mt-16 font-bold font-[Inter] text-center z-10 absolute left-[20%] md:left-[22%] top-[62%] text-4xl md:text-[90px] md:top-[55%] leading-none tracking-tight md:text-left"
      >
        WEB DEVELOPER
      </motion.h1>
    </motion.div>
